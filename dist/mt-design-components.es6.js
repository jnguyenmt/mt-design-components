...
var ButtonGroup = function (props) {
    ...
    return (React.createElement("div", __assign({ className: "button-group" + givenClasses }, rest), children));
};
...
var useEnhancedEffect$1 = typeof window !== 'undefined' && process.env.NODE_ENV !== 'test' ? React.useLayoutEffect : React.useEffect;
/**
...
var FormButton = function (props) {
    ...
    // preserve given class value/s by tacking them onto our guaranteed class/s
    var givenClasses = getAppendAttributeValues(props.className);
    return (React.createElement(Button$1, __assign({ className: givenClasses, ref: ref, color: "primary", variant: "contained" }, rest), children));
};
...
var ButtonLink = function (props) {
    ...
    // preserve given class value/s by tacking them onto our guaranteed class/s
    var givenClasses = getAppendAttributeValues(props.className);
    return (React.createElement("button", __assign({ className: "button-link" + givenClasses }, rest), children));
};
...
var ButtonRow = function (props) {
    ...
    // preserve given class value/s by tacking them onto our guaranteed class/s
    var givenClasses = getAppendAttributeValues(props.className);
    return (React.createElement("div", __assign({ className: "button-row" + givenClasses }, rest), children));
};
...
var SecondaryFormButton = function (props) {
    ...
    // preserve given class value/s by tacking them onto our guaranteed class/s
    var givenClasses = getAppendAttributeValues(props.className);
    return (React.createElement("button", __assign({ className: "secondary-form-button app-button" + givenClasses }, rest), children));
};
...
var FormError = function (props) {
    ...
    // preserve given class value/s by tacking them onto our guaranteed class/s
    var givenClasses = getAppendAttributeValues(props.className);
    return (React.createElement("div", __assign({ className: "form-error" + givenClasses }, rest), children));
};
...
var FormPanel = function (props) {
    ...
    // preserve given class value/s by tacking them onto our guaranteed class/s
    var givenClasses = getAppendAttributeValues(props.className);
    return (React.createElement("div", __assign({ className: "form-panel" + givenClasses }, rest), children));
};
...
function createSvgIcon(path, displayName) {
  var Component = React.memo(React.forwardRef(function (props, ref) {
    return React.createElement(SvgIcon$1, _extends({}, props, {
      ref: ref
    }), path);
  }));
...
var InputField = function (props) {
    ...
    return (React.createElement(TextField$1, __assign({ variant: "outlined", margin: "dense", ref: ref, className: givenClasses }, optionalProps, rest)));
};
...
var InputFieldRow = function (props) {
    ...
    // preserve given class value/s by tacking them onto our guaranteed class/s
    var givenClasses = getAppendAttributeValues(props.className);
    return (React.createElement("div", __assign({ className: "input-field-row" + givenClasses }, rest), children));
};
...
var InputLabel$2 = function (props) {
    ...
    // preserve given class value/s by tacking them onto our guaranteed class/s
    var givenClasses = getAppendAttributeValues(props.className);
    return (React.createElement(FormControlLabel$1, __assign({ className: "input-label" + givenClasses, control: control, label: label }, rest)));
};
...
var _ref$1 = React.createElement(KeyboardArrowLeft, {
  fontSize: "small"
});

var _ref2$1 = React.createElement(KeyboardArrowRight, {
  fontSize: "small"
});
...
function TabSet(props) {
    ...
    if (!tabPanels) {
        ...
        return (React.createElement("div", { className: "mt-tab-set" },
            React.createElement(Tabs$1, { indicatorColor: "primary", value: value, onChange: handleChange, "aria-label": "simple tabs example" }, tabNamesFinal.map(function (tabName, index) { return (React.createElement(Tab$1, __assign({ key: index, label: tabName }, a11yProps(idPrefix, index)))); })),
...
export { ButtonGroup, FormButton, ButtonLink, ButtonRow, SecondaryFormButton, ToggleButtons, FormError, FormPanel, InputField, InputFieldRow, InputLabel$2 as InputLabel, LoadingOverlay, TabSet };
