...
exports.FormButton = (props) => {
    ...
    return (React.createElement("button", Object.assign({ className: "form-button app-button" + givenClasses }, rest), children));
};
exports.default = exports.FormButton;
